...
class TestEmbeddingModelInitialization:
    ...
    def test_initialize_with_cuda(
        self, mock_mps_available, mock_cuda_available, mock_embeddings
    ):
    ...
    def test_initialize_with_custom_model(
        self, mock_mps_available, mock_cuda_available, mock_embeddings, mock_getenv
    ):
    ...
    @patch("src.embeddings.torch.cuda.is_available")
    @patch("src.embeddings.torch.backends.mps.is_available")
    def test_initialize_returns_embeddings_instance(
        self, mock_mps_available, mock_cuda_available, mock_embeddings
    ):
    ...
    @patch("src.embeddings.torch.cuda.is_available")
    @patch("src.embeddings.torch.backends.mps.is_available")
    def test_device_priority_cuda_over_mps(
        self, mock_mps_available, mock_cuda_available, mock_embeddings
    ):
    ...
    @patch("src.embeddings.torch.cuda.is_available")
    @patch("src.embeddings.torch.backends.mps.is_available")
    def test_model_kwargs_structure(
        self, mock_mps_available, mock_cuda_available, mock_embeddings
    ):
    ...
    @patch("src.embeddings.torch.cuda.is_available")
    @patch("src.embeddings.torch.backends.mps.is_available")
    def test_device_passed_to_embeddings(
        self, mock_mps_available, mock_cuda_available, mock_embeddings
    ):
    ...
    def test_logging_device_info(
        self, mock_logger, mock_mps_available, mock_cuda_available, mock_embeddings
    ):
    ...
    @patch("src.embeddings.torch.cuda.is_available")
    @patch("src.embeddings.torch.backends.mps.is_available")
    def test_multiple_calls_return_different_instances(
        self, mock_mps_available, mock_cuda_available, mock_embeddings
    ):
...
class TestEmbeddingModelDeviceDetection:
    ...
    @patch("src.embeddings.torch.cuda.is_available")
    @patch("src.embeddings.torch.backends.mps.is_available")
    def test_device_parameter_format(
        self, mock_mps_available, mock_cuda_available, mock_embeddings
    ):
