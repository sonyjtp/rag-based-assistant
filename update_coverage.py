...
def get_coverage_from_xml(xml_file: str = "coverage.xml") -> float:
    """
...
def update_readme_coverage(coverage_percent: float, readme_file: str = "README.md") -> bool:
    """
    ...
    try:
        ...
        if updated_content == content:
            print(f"⚠️  Could not find coverage badge in {readme_file}")
            return False
        ...
        print(f"✅ Updated README.md with coverage: {coverage_rounded}%")
        return True
...
def main():
    ...
    print("📊 Updating coverage badge in README.md...")
